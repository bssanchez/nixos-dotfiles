...
Item {
    ...
    property color color: theme.colors.background || "black"
    property bool asyncShapeLoad: true
    ...
    Loader {
        anchors.fill: parent
        asynchronous: root.asyncShapeLoad
    ...
    component BubbleShape: Shape {
        ...
        ShapePath {
            ...
            strokeColor: theme.colors.background || "black"
            strokeWidth: 0
